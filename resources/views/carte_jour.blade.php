          ...
          <div class="_form-08-main">
            <div id='sectionAimprimer'>
              <div class="_form-08-head">
                ...
                <div class="container">
                  <p> <strong>{{$carte->nom}} {{$carte->prenom}}</strong> vous êtes prié de bien vouloir vous présenter à la
                    @if(strcasecmp($carte->faculte,"Centre  Universitaire de Patsy") == 0 || strcasecmp($carte->faculte,"Centre Universitaire de Mohéli") == 0 )
                    Scolarité
                    @else
                    Direction des Etudes et de la Scolarité 
                    @endif
                    le {{\Carbon\Carbon::parse($dates)->translatedFormat('l j F Y')}} pour recuperer votre carte scolaire
                  </p>
